...
var conversation = watson.conversation( {
  ...
  username: process.env.CONVERSATION_USERNAME || 'cf3440d9-9591-4ea5-bd3c-3a9c7ac67d1f',
  password: process.env.CONVERSATION_PASSWORD || 'mPGCpUs1MIlm',
...
app.post( '/api/message', function(req, res) {
  var workspace = process.env.WORKSPACE_ID || '34c13618-22b1-48f5-b7b6-f496a03d4371';
  //var workspace = process.env.WORKSPACE_ID || 'a83099e3-3250-4575-a46c-bf03f4a6503d';
...
var textToSpeech = watson.text_to_speech({
  version: 'v1',
  username: 'ed7426dc-4b6f-43b0-b589-c601ebc524b0',
  password: '5jIfP2eU0UwX'
});
...
app.get('/api/call', function(req, res) {
  res.output.text = "Testing Call API";
  res.send("Testing");
});
